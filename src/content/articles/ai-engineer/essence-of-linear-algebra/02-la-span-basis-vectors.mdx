...
<Definition
  term="span"
  langs={{
    en: 'The span of a set of vectors is the full collection of every linear combination of them. It is the answer to "where can these arrows take me?"',
    bn: 'কিছু ভেক্টরের span হলো ওই ভেক্টরগুলোর সব linear combination মিলিয়ে যত পয়েন্টে পৌঁছানো যায়, তার পুরো সংগ্রহ। এটা এই প্রশ্নের উত্তর দেয়, "এই তীরগুলো আমাকে কোথায় কোথায় নিয়ে যেতে পারে?"',
    hi: 'किसी वेक्टरों के समूह का स्पैन उनके सभी लीनियर कॉम्बिनेशन का पूरा संग्रह है। यह इस सवाल का जवाब देता है, "ये तीर मुझे कहां-कहां ले जा सकते हैं?"',
    ar: 'امتداد (سبان) مجموعة من المتجهات هو المجموعة الكاملة لكل التركيبات الخطية لها. وهو يجيب عن السؤال: "إلى أين يمكن لهذه الأسهم أن تأخذني؟"',
  }}
/>
...
<Definition
  term="basis"
  langs={{
    en: 'A basis of a space is a set of linearly independent vectors that spans that space.',
    bn: 'কোনো স্পেসের একটি বেসিস হলো এমন কিছু লিনিয়ারলি ইন্ডিপেন্ডেন্ট (পরস্পর স্বাধীন) ভেক্টরের সেট, যেগুলো মিলে পুরো স্পেসটাকে স্প্যান করে। অর্থাৎ ওই ভেক্টরগুলো স্কেল ও যোগ করে স্পেসের যেকোনো বিন্দুতে পৌঁছানো যায়।',
    hi: 'किसी स्पेस का बेसिस ऐसे लीनियरली इंडिपेंडेंट (आपस में स्वतंत्र) वेक्टरों का समूह है, जो मिलकर पूरे स्पेस को स्पैन करते हैं — यानी उन्हें स्केल और जोड़कर स्पेस के किसी भी बिंदु तक पहुँचा जा सकता है।',
    ar: 'أساس الفضاء هو مجموعة من المتجهات المستقلة خطياً التي تغطي ذلك الفضاء بالكامل — أي يمكن الوصول إلى أي نقطة في الفضاء بضربها في أعداد وجمعها.',
  }}
/>
