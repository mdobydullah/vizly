...
<MermaidBlock chart={`
graph TB
    AI["🤖 Artificial Intelligence<br/><i>Machines that act smart</i>"]
    ML["📊 Machine Learning<br/><i>Learns from examples</i>"]
    DL["🧠 Deep Learning<br/><i>Learns with brain-like networks</i>"]
    GenAI["✨ Generative AI<br/><i>Creates new stuff — text, images, code</i>"]

    AI --> ML
    ML --> DL
    DL --> GenAI

    style AI fill:#b985f420,stroke:#b985f4,color:#fff
    style ML fill:#60a5fa20,stroke:#60a5fa,color:#fff
    style DL fill:#00e5ff20,stroke:#00e5ff,color:#fff
    style GenAI fill:#3effa320,stroke:#3effa3,color:#fff
`} primaryColor="#b985f4" />
...
<MermaidBlock chart={`
graph LR
    A["📧 Show it 10,000<br/>spam + normal emails"] --> B["🤖 ML Algorithm<br/>finds patterns"]
    B --> C["📐 Trained Model"]
    C --> D["✅ Can now judge<br/>new emails"]

    style A fill:#b985f420,stroke:#b985f4,color:#fff
    style B fill:#60a5fa20,stroke:#60a5fa,color:#fff
    style C fill:#00e5ff20,stroke:#00e5ff,color:#fff
    style D fill:#3effa320,stroke:#3effa3,color:#fff
`} primaryColor="#b985f4" />
...
graph TB
    ML["Machine Learning"]
    SL["📚 Supervised<br/><i>Has the answer key</i>"]
    UL["🔍 Unsupervised<br/><i>No answers, find patterns</i>"]
    RL["🎮 Reinforcement<br/><i>Try stuff, get rewards</i>"]

    ML --> SL
    ML --> UL
    ML --> RL

    style ML fill:#b985f420,stroke:#b985f4,color:#fff
    style SL fill:#60a5fa20,stroke:#60a5fa,color:#fff
    style UL fill:#00e5ff20,stroke:#00e5ff,color:#fff
    style RL fill:#3effa320,stroke:#3effa3,color:#fff
`} primaryColor="#b985f4" />

---

## Why now? AI has been around for 70 years.
