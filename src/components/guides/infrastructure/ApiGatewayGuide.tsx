...
import { Settings, Youtube, Globe, BookOpen, ExternalLink, ShieldCheck, Zap, Activity, Repeat, Grid, Lock, Play, Pause, RotateCcw } from 'lucide-react';
    ...
    useEffect(() => {
        ...
        if (isPlaying) {
            if (currentStepIdx < FLOW_STEPS.length - 1) {
                const stepTime = currentStepIdx === -1 ? 500 : 1800 * animationSpeed;
                t = setTimeout(() => {
